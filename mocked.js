const mockData = () => {
  ...
  localStorage.setItem(
    "surveys.15",
    '{"name":"tel-aviv","author":"tim","creationDate":"2023-01-10T07:28:20.907Z","id":15}'
  );
  ...
  localStorage.setItem(
    "surveys.author",
    '[{"id":13,"author":"dsaads"},{"id":10,"author":"dsfdfs"},{"id":14,"author":"dsfsd"},{"id":12,"author":"fgdfdg"},{"id":16,"author":"me"},{"id":9,"author":"s9"},{"id":15,"author":"tim"}]'
  );

  localStorage.setItem(
    "surveys.creationDate",
    '[{"id":9,"creationDate":"2023-01-09T13:20:27.327Z"},{"id":10,"creationDate":"2023-01-09T13:33:07.096Z"},{"id":12,"creationDate":"2023-01-09T20:52:46.909Z"},{"id":13,"creationDate":"2023-01-09T20:59:10.986Z"},{"id":14,"creationDate":"2023-01-09T22:04:41.535Z"},{"id":15,"creationDate":"2023-01-10T07:28:20.907Z"},{"id":16,"creationDate":"2023-01-10T07:31:04.380Z"}]'
  );

  localStorage.setItem(
    "surveys.name",
    '[{"id":10,"name":"dfdsf"},{"id":13,"name":"dsadsa"},{"id":12,"name":"fgdgdf"},{"id":16,"name":"lot-of-questions"},{"id":9,"name":"s9"},{"id":14,"name":"sfd"},{"id":15,"name":"tel-aviv"}]'
  );

  localStorage.setItem("surveysAnswers.9", '[["a1","a2"]]');

  localStorage.setItem(
    "surveysAnswers.10",
    '[["a1",["a1"]],["a1",["a1"]],["a1",["a1","a2"]],["a1",["a2"]],["a1",["a1","a2"]]]'
  );

  localStorage.setItem("surveysAnswers.12", '[["kjk"]]');

  localStorage.setItem("surveysAnswers.13", '[["answer"],["answer2"]]');

  localStorage.setItem("surveysAnswers.14", '[["co"]]');

  localStorage.setItem(
    "surveysAnswers.15",
    '[["hi","hi2","a1"],["k","na","a1"],["yes","no","a2"]]'
  );
  ...
  localStorage.setItem(
    "surveysQuestions.15",
    '[{"type":"open","possibleAnswersCounter":-1,"text":"q1"},{"type":"open","possibleAnswersCounter":-1,"text":"q2"},{"possibleAnswers":["a1","a2","a3"],"possibleAnswersCounter":3,"type":"closed","text":"q3"}]'
  );
